...
func mapPostgresResourceModel(data *DatabasePostgresModel, db *database.Database) {
	...
	data.PostgresInitdbArgs = configure.ValueStringValue(db.PostgresInitdbArgs, data.PostgresInitdbArgs)
	data.PostgresHostAuthMethod = configure.ValueStringValue(db.PostgresHostAuthMethod, data.PostgresHostAuthMethod)
	data.PostgresConf = configure.ValueStringValue(db.PostgresConf, data.PostgresConf)
